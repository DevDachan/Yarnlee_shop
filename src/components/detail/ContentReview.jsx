...
function Content(props) {
  ...
  useEffect(() => {
    ...
    axios({
      method: "get",
      url: 'http://localhost:8090/shop-backend/product/review/id/'+productId
    })
    ...
    <Wrapper>
      <div className="detail_main" id="main">
        <div className="inner">
          ...
          <h2> Review </h2>
          <div className="row">
            {product && <div id="contentArea" dangerouslySetInnerHTML={{__html: reviewContent}} />}
          </div>

          <div class="row">
            <div class="col-6-large mb-3">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">너무 좋아요!!</h5>

                    <img style={{width: "70%"}} src={"http://localhost:3000/productImage/431969.jpg"} />
                  <p className="card-text review-content">내용 생략되는지 확인하기내용 생략되는지 확인하기내용 생략되는지 확인하기
                  내용 생략되는지 확인하기내용 생략되는지 확인하기내용 생략되는지 확인하기</p>
